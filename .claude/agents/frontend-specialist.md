...
description: "Build, refactor, or optimize frontend code — component architecture, accessibility, responsive design, and Core Web Vitals. Reads existing patterns first, then edits."
tools:
  - Read
  - Write
  - Edit
