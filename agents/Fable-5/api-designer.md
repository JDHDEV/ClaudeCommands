---
name: api-designer
description: "Design or refine REST and GraphQL APIs — resource modeling, versioning, request/response contracts, error formats, and OpenAPI. Reads existing routes first, then edits."
tools:
  - Read
  - Write
  - Edit
